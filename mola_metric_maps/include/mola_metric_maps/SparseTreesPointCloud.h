                              ...
                              public mola::OptionsCapable
{
 ...
 public:
   ...
   *  changing `grid_size` after the map already holds data requires discarding its contents
   *  (see `setGridProperties()`); use `trySetCreationOptions()` to apply it safely.
   */
